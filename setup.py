...
extras_require = {
    ...
    'elasticsearch2': [
        'invenio-search[elasticsearch2]' + invenio_search_version,
    ],
    'elasticsearch5': [
        'invenio-search[elasticsearch5]' + invenio_search_version,
    ],
    'docs': [
        'Sphinx>=1.5.1',
    ],
...
install_requires = [
    ...
    'invenio-accounts>=1.0.0b10,<1.1.0',
